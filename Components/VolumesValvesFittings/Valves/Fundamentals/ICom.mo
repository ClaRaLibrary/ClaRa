...
//  SI.Pressure Delta_p "Pressure difference p_in - p_out" annotation(Dialog);
  ...
  Basics.Units.Pressure p_out "Outlet pressure" annotation (Dialog);
  Real opening_ "Opening of the valve (p.u.)" annotation(Dialog);
  Basics.Units.DensityMassSpecific rho_in "Inlet density" annotation (Dialog);
  ...
  Basics.Units.EnthalpyMassSpecific h_in "Inlet enthalpy" annotation (Dialog);
  Basics.Units.Pressure p_crit "Critical pressure" annotation (Dialog);
  Basics.Units.Pressure p_vap_in "Vapour pressure at inlet temperature" annotation (Dialog);
