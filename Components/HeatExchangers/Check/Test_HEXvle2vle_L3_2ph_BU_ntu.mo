...
//__________________________________________________________________________//
 ...
 extends ClaRa.Basics.Icons.PackageIcons.ExecutableRegressiong100;
  ...
  Visualisation.Hexdisplay_3 hexdisplay_3_1(
    ...
    z_i=hex.wall.summary.eCom.z_i)                      annotation (Placement(transformation(extent={{-86,-18},{8,70}})));
  Visualisation.Quadruple quadruple(largeFonts=false) annotation (Placement(transformation(extent={{42,-50},{72,-40}})));
