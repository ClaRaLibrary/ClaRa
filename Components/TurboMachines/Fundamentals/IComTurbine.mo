...
//____Outlet______________________________________________________________________________
//  Real gamma_out "Heat capacity ratio at outlet" annotation (Dialog(tab="Outlet"));
