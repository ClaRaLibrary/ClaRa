...
<p>Version means first ClaRa version where the applied change was published.</p>
      ...
      graphics={                                                                                                            Text(
          ...
          lineColor=DynamicSelect({220,220,220}, if u  then {255,0,255} else {150,150,150}),
          textString=DynamicSelect(" Boolean ", String(u))), Line(points={{-100,0},{100,0}}, color={255,0,255})},
                   coordinateSystem(preserveAspectRatio=false)),        Diagram(coordinateSystem(preserveAspectRatio=false), graphics={Line(points={{-100,0},{100,0}}, color={255,0,255})}));
end TinyBooleanDisplay;
