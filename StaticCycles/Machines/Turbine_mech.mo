...
//__________________________________________________________________________//
  ...
  final parameter ClaRa.Basics.Units.DensityMassSpecific rho_in=TILMedia.VLEFluid.MixtureCompatible.Functions.density_phxi(
      medium,
      p_in,
      h_in) "Inlet density";
...
//protected
  ...
  final parameter ClaRa.Basics.Units.EnthalpyMassSpecific h_out=h_in + efficiency*(TILMedia.VLEFluid.MixtureCompatible.Functions.specificEnthalpy_psxi(
      medium,
      p_out,
...
public
  ...
  ClaRa.StaticCycles.Fundamentals.PowerSignal_A power_in(s=power_out.s)   annotation (Placement(transformation(extent={{-68,-10},{-60,10}}), iconTransformation(extent={{-68,-10},{-60,10}})));
  ClaRa.StaticCycles.Fundamentals.PowerSignal_B power_out(power=P_in + P_turbine) annotation (Placement(transformation(extent={{60,-10},{68,10}}), iconTransformation(extent={{60,-10},{68,10}})));
initial equation
  inlet.m_flow=m_flow;
  inlet.p=p_in;
  inlet.h=h_in;
