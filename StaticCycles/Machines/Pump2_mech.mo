...
//__________________________________________________________________________//
  ...
  ClaRa.StaticCycles.Fundamentals.PowerSignal_B powerIn(power=P_pump + P_in) annotation (Placement(transformation(extent={{-4,-10},{4,10}},
        rotation=270,
        origin={0,-104}),iconTransformation(
        extent={{-4,-10},{4,10}},
        rotation=270,
        origin={0,-104})));
  ClaRa.StaticCycles.Fundamentals.PowerSignal_A power_in(s=powerIn.s)   annotation (Placement(transformation(extent={{-4,-10},{4,10}},
        rotation=270,
        origin={0,104}),                                                                                                                     iconTransformation(extent={{-4,-10},{4,10}},
        rotation=270,
        origin={0,104})));
