...
//__________________________________________________________________________//
  ...
  // Orange input:   Value of p and m_flow are unknown in component and provided BY neighbor component, values of T and xi are known and provided FOR neighbor component.
  ...
  parameter ClaRa.Basics.Units.Pressure p_nom;

  ClaRa.StaticCycles.Fundamentals.FlueGasSignal_orange_a inlet(
    flueGas=flueGas,
    m_flow = m_flow_nom,
    p = p_nom)
      annotation (Placement(transformation(extent={{-108,-10},{-100,10}}), iconTransformation(extent={{-108,-10},{-100,10}})));
...
<p>Version means first ClaRa version where the applied change was published.</p>
        ...
        Text(
          ...
          fillPattern=FillPattern.Solid,
          textString="%p_nom"),
        Line(points={{-60,100},{-100,0},{-60,-100}},
                                                  color={244,125,35})}),
                                                                 Diagram(graphics,
