...
//__________________________________________________________________________//
  ...
  ClaRa.StaticCycles.Fundamentals.FlueGasSignal_purple_a inlet_2(flueGas=gas, p=p) annotation (Placement(transformation(
        extent={{-4,-10},{4,10}},
        rotation=90,
        origin={-10,-24})));
...
<p>Version means first ClaRa version where the applied change was published.</p>
         ...
         Icon(coordinateSystem(preserveAspectRatio=false, extent={{-60,-20},{40,40}}), graphics={
          ...
          fillPattern=DynamicSelect(FillPattern.Solid, if m_flow_in1 > 0 then FillPattern.Solid else FillPattern.Forward))}),                                                  Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-60,-20},{40,40}}), graphics={
                                   Polygon(
          points={{-60,40},{40,40},{40,20},{0,20},{0,-20},{-20,-20},{-20,20},{
              -60,20},{-60,40}},
