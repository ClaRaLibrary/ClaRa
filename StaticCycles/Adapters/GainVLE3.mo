...
//__________________________________________________________________________//
  ...
  ClaRa.StaticCycles.Fundamentals.SteamSignal_red_a inlet(p=p, m_flow=m_flow_1, Medium=medium) annotation (Placement(transformation(extent={{-110,-10},{-100,10}}),
                                                                                                                                                                  iconTransformation(extent={{-110,-10},{-100,10}})));
  ClaRa.StaticCycles.Fundamentals.SteamSignal_red_b outlet(h=h, Medium=medium) annotation (Placement(transformation(extent={{100,-10},{110,10}}),
                                                                                                                                                iconTransformation(extent={{100,-10},{110,10}})));
initial equation
  outlet.p=p;
  inlet.h=h;
  outlet.m_flow=m_flow_2;
