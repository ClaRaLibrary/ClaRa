...
record StaticMeasurementValue "Sums up important values of a measurement"
...
//__________________________________________________________________________//
  ...
  extends ClaRa.Basics.Icons.RecordIconGraph;
  parameter Real mean "Mean value";
  parameter String KKS = "" "KKS identifier";
  parameter Real P05 "The  5% percentile";
  parameter Real P95 "The 95% percenile";
  parameter Real Delta_P90 = P95-P05 "Band width P95-P05";
