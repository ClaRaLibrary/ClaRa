...
//Area of Heat Transfer
  ...
  final parameter Modelica.Units.SI.ThermalResistance HR_nom=(radius_o - radius_i)/(solid[1].lambda_nominal*A_heat_m) "Nominal conductive heat resistance";
...
model Summary
  ...
  input SI.Temperature T_i_sat "Inner side saturation temperature";
  input SI.Temperature T_o_sat "Outer side saturation temperature";
